...
class block_archivedsessions_testcase extends advanced_testcase {
    ...
    public function test_html_attributes() {
        ...
        self::assertStringContainsString('hidden-block', $htmlattribute['class']);
    ...
    public function test_init() {
        ...
        $block = new \block_archivedsessions();
        $block->init();
        self::assertStringContainsString(get_string('pluginname', 'block_archivedsessions'), $block->title);
    ...
    public function test_get_required_javascript() {
        ...
        self::assertStringContainsString('block_archivedsessions/block_archivedsessions', $amdjs[1]);
    ...
    public function test_help_button() {
        ...
        self::assertStringContainsString(get_string('helpbuttontext', 'block_archivedsessions', get_config('theme_mentor', 'faq')),
            $helpbutton);
        self::assertStringContainsString(get_string('helpbuttontexttitle', 'block_archivedsessions'), $helpbutton);
